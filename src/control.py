...
class Control:
	...
	kietol, hbox, progBar = None, None, None
	
	#
	#  Creates and returns a control group for kietol.
	#
	...
	def seekPercent(self, widget, event):
		...
		self.kietol.mplayer.seek(percent, 1)
		
		if self.kietol.mplayer.mplayerIn:  #little cheat
